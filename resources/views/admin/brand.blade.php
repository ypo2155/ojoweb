            ...
            <div class="container-fluid ">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div>
                            <a class="btn btn-primary btn" href="{{route('adminclientupload')}}">Add</a>
                        </div>
                        <br>
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="card">
                                <img class="card-img-top img-fluid"
                                    src="{{ asset('/storage/image/clients/' . $brand->BrandImg) }}"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">{{$brand->BrandText}}</h5>
                                   
                                    <a href="{{route('adminclientedit', $brand->id)}}"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{route('adminclientdelete', $brand->id)}}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="button"
