                    ...
                    <div class="blog-post-wrapper">
                        ...
                        <article class="single-post-item">
                            ...
                            <div class="post-content-wrapper">
                                ...
                                <h3 class="post-title border_effect"><a href="{{route('newdetail', $new->slug)}}">{{ $new->NewText1 }}</a></h3>
                                <div class="post-excerpt">
                                    <p>{!! Str::limit($new->NewText2, 300) !!}</p>
                                </div>
                                <div class="post-read-more">
                                    <a href="{{route('newdetail', $new->slug )}}" class="btn-link ul_li">Read More <span><img src="img/icon/arrow-right2.svg" alt=""></span></a>
                                </div>
                            </div>
                        </article>
                        @endforeach
                        ...
                        <div class="pagination_wrap pt-10">
                            ...
                            {{ $news->links('pagination::ojodefault') }}  
                        </div>
