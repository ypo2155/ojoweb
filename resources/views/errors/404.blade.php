                                ...
                                <div class="col-lg-7">
                                    <div class="p-5">
                                        <div class="text-center mb-5">
                                            <img style="width: 100px;height: auto;" src="{{ asset('assets/images/logo/logo.png')}}">
                                        </div>
                                        
                                        <div class="text-center">
                                            <img src="{{ asset('assets/images/404-error.svg')}}" alt="error" height="140">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-12 text-center">
                                                <a href="{{ route('index')}}" class="btn btn-success waves-effect waves-light"><i class="mdi mdi-home mr-2"></i>Back to Home </a>
                                            </div> <!-- end col -->
                                        </div>
                                        <!-- end row -->
                                    </div> <!-- end .padding-5 -->
